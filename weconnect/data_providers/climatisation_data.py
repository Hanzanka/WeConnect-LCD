...
class Weconnect_climate_data(Weconnect_vehicle_data):
    ...
    def __get_climate_status(self, climate_status: ClimatizationStatus) -> dict:
        ...
        climate_status_data[data.getGlobalAddress()] = Weconnect_vehicle_data_property(
            "remaining time",
            data.value,
    ...
    def __get_climate_settings(self, climate_settings: ClimatizationSettings) -> dict:
        ...
        climate_settings_data[data.getGlobalAddress()] = Weconnect_vehicle_data_property(
            "target temperature",
            data.value,
    ...
    def __get_window_heating_status(
        ...
        window_heating_data[data.getGlobalAddress()] = Weconnect_vehicle_data_property(
            "rear window heating",
